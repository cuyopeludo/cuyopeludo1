...
document.getElementById("word").value = "";
 ...
 function check (){
	kokas=document.getElementById("input_check_box").value;

	answer = kokas.toLowerCase(); console.log("answer in lower case - " + answer)
...
if (question_turn=="player1") {
	...
	document.getElementById("player_question").innerHTML="opi"+player2_name;

} else {
	question_turn="player1";
	document.getElementById("player_question").innerHTML="ko"+player1_name;
}

if (answer_turn=="player1") {
	answer_turn="player2";
	document.getElementById("player_answer").innerHTML="turnodecontestar"+player2_name;

} else {
	answer_turn="player1";
	document.getElementById("player_answer").innerHTML="turnoderesponder"+player1_name;
